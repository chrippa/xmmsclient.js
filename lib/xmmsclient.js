...
(function() {
  ...
  Value = (function() {
    ...
    Value.serialize = function(bindata, val) {
      var coll, i, key, length, n, value, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _results, _results1, _results2;
      switch (typeof val) {
        case "string":
          ...
          if (Array.isArray(val)) {
            ...
            if (n > 0) {
              ...
              for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
                coll = _ref2[_k];
                _results1.push(Value.serialize(bindata, coll));
              }
              return _results1;
            }
          } else {
            ...
            for (key in val) {
              value = val[key];
              bindata.write_string(key);
              _results2.push(Value.serialize(bindata, value));
            }
            return _results2;
          }
      }
