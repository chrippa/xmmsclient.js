...
(function() {
  ...
  Value = (function() {
    ...
    Value.serialize_coll = function(bindata, val) {
      var coll, n, value, _i, _j, _len, _len1, _ref, _ref1, _results;
      ...
      if (n > 0) {
        ...
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          ...
          if (coll instanceof Collection) {
            _results.push(Value.serialize(bindata, coll));
          } else {
    ...
    Value.serialize_list = function(bindata, val) {
      ...
      switch (typeof val) {
        ...
        case "object":
          if (Array.isArray(val)) {
            ...
            return Value.serialize_list(bindata, val);
          } else if (val instanceof Bindata) {
            bindata.write_int(this.Type.Binary);
            return Value.serialize_bin(bindata, val);
          } else if (val instanceof Collection) {
            bindata.write_int(this.Type.Collection);
            return Value.serialize_coll(bindata, val);
          } else {
            bindata.write_int(this.Type.Dictionary);
            return Value.serialize_dict(bindata, val);
          }
      }
    };
    ...
    Value.deserialize_coll = function(bindata) {
      var coll, i, length, type, value, _i, _j;
  ...
  Client = (function() {
    ...
    Client.prototype.protocol_version = 20;
