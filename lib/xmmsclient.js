(function() {
  ...
  Client = (function() {
    ...
    Client.prototype.connect = function(ipcpath) {
      ...
      parsed = url.parse(this.ipcpath);
      if (parsed.protocol === "unix:") {
        this.socktype = "node";
        return this.connect_node(parsed.path);
      } else if (parsed.protocol === "tcp:") {
        this.socktype = "node";
        return this.connect_node(parsed.port, parsed.hostname);
    ...
    Client.prototype.connect_node = function(port, path) {
      var _this = this;
