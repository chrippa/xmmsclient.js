...
(function() {
  var Bindata, CollSync, Collection, Config, Courier, IpcManager, Main, MediainfoReader, Medialib, Playback, Playlist, Visualization, Xform, xmmsclient;
  ...
  Playlist = (function() {
    ...
    function Playlist(client1) {
      this.client = client1;
    }

    Playlist.prototype.replace = function(playlist, replacement, action) {
    ...
    Playlist.prototype.add_collection = function(name, collection) {
    ...
    Playlist.prototype.insert_collection = function(name, position, collection) {
  ...
  Collection = (function() {
    ...
    Collection.prototype.query_infos = function(collection, lim_start, lim_len, fetch, group) {
  ...
  Visualization = (function() {
    ...
    function Visualization(client1) {
      this.client = client1;
    }
  ...
  MediainfoReader = (function() {
    ...
    function MediainfoReader(client1) {
      this.client = client1;
    }
  ...
  CollSync = (function() {
    CollSync.prototype.object_id = 11;

    function CollSync(client1) {
      this.client = client1;
    }

    CollSync.prototype.sync = function() {
  ...
  Courier = (function() {
    Courier.prototype.object_id = 12;

    function Courier(client1) {
      this.client = client1;
    }

    Courier.prototype.send_message = function(dest, reply_policy, payload) {
    ...
    Courier.prototype.reply = function(msgid, reply_policy, payload) {
    ...
    Courier.prototype.get_connected_clients = function() {
    ...
    Courier.prototype.broadcast_message = function() {
  ...
  IpcManager = (function() {
    IpcManager.prototype.object_id = 13;

    function IpcManager(client1) {
      this.client = client1;
    }

    IpcManager.prototype.broadcast_client_connected = function() {
    ...
    IpcManager.prototype.broadcast_client_disconnected = function() {
